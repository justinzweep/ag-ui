...
ToolCall = TypedDict("ToolCall", {"id": str, "name": str, "args": Dict[str, Any]})
...
PredictStateTool = TypedDict(
    "PredictStateTool", {"tool": str, "state_key": str, "tool_argument": str}
)

LangGraphReasoning = TypedDict(
    "LangGraphReasoning", {"type": str, "text": str, "index": int}
)
